...
export const DeclineJobRequestActionSheet = React.forwardRef<
  ActionSheetRef,
  DeclineJobRequestActionSheetProps
    ...
    >
      <View className="gap-4">
        ...
        <Text className="text-xs text-muted-foreground leading-relaxed">
          Are you sure you want to decline this application from{" "}
...
DeclineJobRequestActionSheet.displayName = "DeclineJobRequestActionSheet";
